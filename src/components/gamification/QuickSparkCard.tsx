        ...
        <AnimatePresence mode="wait">
          {isCompleted ? (
            <motion.div
              ...
              className="flex items-center gap-2 text-xs font-bold text-[#78FFD6] bg-[#78FFD6]/15 border border-[#78FFD6]/40 px-4 py-2 rounded-xl"
            >
              <CheckCircle2 className="w-4 h-4 text-[#78FFD6]" />
              <span>Spark Ignited! Radiant Radiance Logged ✦</span>
            </motion.div>
          ) : (
            <motion.button
              key="ignite-btn"
