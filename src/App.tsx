...
const AppContent: React.FC = () => {
  ...
  return (
    <div
      className="relative min-h-screen bg-[#0B0A10] text-white selection:bg-amber-500/20 selection:text-amber-200 overflow-x-hidden font-sans transition-colors duration-500"
    >
      ...
      <AnimatePresence>
        {confirmationToast && (
          <motion.div
            ...
            className="fixed top-20 left-1/2 -translate-x-1/2 z-50 px-4 py-2.5 rounded-xl bg-[#131219] border border-white/[0.08] shadow-[0_12px_32px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.06)] flex items-center gap-3 text-xs text-white"
          >
            <div
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-white text-[#0B0A10] font-semibold text-xs hover:bg-[#F4F4F5] transition-colors flex items-center gap-1 cursor-pointer active:scale-[0.97]"
            >
        ...
        {recapPromptAvailable && !isRecapModalOpen && recapData && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 10 }}
            className="fixed bottom-6 left-6 z-40 p-3.5 rounded-xl bg-[#131219] border border-white/[0.08] shadow-[0_12px_32px_rgba(0,0,0,0.6)] flex items-center gap-3 text-xs text-white max-w-sm"
          >
            <div className="w-7 h-7 rounded-lg bg-white/[0.05] border border-white/[0.1] flex items-center justify-center text-[#F59E0B] shrink-0">
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-white text-[#0B0A10] font-semibold text-xs transition-colors shrink-0 cursor-pointer active:scale-[0.97]"
            >
              View
            </button>
          </motion.div>
